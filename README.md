...
Django. For example, to get the latest compatible release for Django 6.2.x:

```bash
pip install django-mongodb-backend==6.2.*
```
...
URL corresponds to your version of Django (e.g. `6.2.x.zip` for any Django
6.2.x version).

```bash
django-admin startproject example --template https://github.com/mongodb-labs/django-mongodb-project/archive/refs/heads/6.2.x.zip
```
