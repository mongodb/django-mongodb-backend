...
merge of a "Add support for Django X.Y" PR. Before merging that PR, a branch is
created off of main to track the previous feature release version. For example,
the 5.1.x branch is created shortly after the release of Django 5.2, and main
starts tracking the Django 5.2.x series.
