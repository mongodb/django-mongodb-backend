...
By default, query execution uses Django and MongoDB's default behavior of
...
are not supported. Instead, this package provides its own :doc:`transaction
APIs </topics/transactions>`.
