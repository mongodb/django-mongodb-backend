...
- Added :doc:`Django REST Framework support </howto/rest-framework>` for
  :class:`~django_mongodb_backend.models.EmbeddedModel` fields via the
  optional ``django-mongodb-backend[rest_framework]`` extra, including
  serializers for embedded models, arrays, and polymorphic fields.
