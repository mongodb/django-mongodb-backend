...
.. code-block:: bash
    ...
    $ django-admin startproject mysite --template https://github.com/mongodb-labs/django-mongodb-project/archive/refs/heads/6.2.x.zip

(If you're using a version of Django other than 6.2.x, replace the two numbers
