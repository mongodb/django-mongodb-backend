...
class ModelTests(TestCase):
    ...
    def test_pre_save(self):
        ...
        obj.save()
        self.assertEqual(truncate_ms(obj.pet.created_at), created_at)
        self.assertGreater(truncate_ms(obj.pet.updated_at), updated_at)
...
class QueryingTests(TestCase):
    ...
    def test_boolean(self):
        self.assertCountEqual(
            ...
            [x for i, x in enumerate(self.dog_owners, 1) if i % 2 == 1],
        )
