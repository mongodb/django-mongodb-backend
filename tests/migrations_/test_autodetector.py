...
class AutodetectorTests(BaseAutodetectorTests):
    ...
    def test_add_embedded_field(self):
        """Detection of new embedded fields (Authr.age)."""
        ...
        # Right number/type of migrations?
        self.assertNumberMigrations(changes, "testapp", 1)
        self.assertOperationTypes(changes, "testapp", 0, ["AddEmbeddedField"])
        self.assertOperationAttributes(
            changes, "testapp", 0, 0, model_name="book", field_name="author.age"
        )
    ...
    def test_add_not_null_field_with_db_default(self, mocked_ask_method):
        ...
        self.assertOperationFieldAttributes(changes, "testapp", 0, 0, db_default="Ada Lovelace")
    ...
    def test_add_fk_before_generated_field(self):
        ...
        changes = self.get_changes([initial_state], updated_state)
        self.assertNumberMigrations(changes, "testapp", 1)
        self.assertOperationTypes(changes, "testapp", 0, ["CreateModel", "AddField", "AddField"])
        self.assertOperationFieldAttributes(
        ...
        after = [
            ...
            ModelState(
                ...
                [
                    ...
                    (
                        "foo",
                        models.ForeignKey("app.Foo", models.CASCADE, to_field="renamed_field"),
                    ),
                ],
            ),
        ]
        ...
        after = [
            ...
            ModelState(
                ...
                [
                    ...
                    (
                        "renamed_foo",
                        models.ForeignKey("app.Foo", models.CASCADE, db_column="foo_id"),
                    ),
                ],
            ),
        ]
    ...
    def test_alter_regex_string_to_compiled_regex(self):
        ...
        from_state = ModelState(
            ...
            [
                (
                    "id",
                    models.AutoField(primary_key=True, validators=[RegexValidator(regex_string)]),
                )
            ],
        )
        to_state = ModelState(
        ...
        before_state = [
            ...
            ModelState(
                ...
                fields=[
                    ...
                    (
                        "category",
                        models.ForeignKey("testapp.Category", models.SET_NULL, null=True),
                    ),
                ],
                options={
                    "constraints": [
    ...
    def test_rename_indexes(self):
        book_renamed_indexes = ModelState(
            ...
            {
                "indexes": [
                    models.Index(fields=["author", "title"], name="renamed_book_title_author_idx")
                ],
            },
        )
        changes = self.get_changes(
    ...
    def test_constraint_dropped_and_recreated(self):
        ...
        author_name_check_constraint_lowercased = copy.deepcopy(self.author_name_check_constraint)
        author_name_check_constraint_lowercased.options = {"constraints": [altered_constraint]}
        changes = self.get_changes(
            [self.author_name_check_constraint],
    ...
    def test_create_with_through_model_separate_apps(self):
        author_with_m2m_through = ModelState(
            ...
            [
                ...
                (
                    "publishers",
                    models.ManyToManyField("testapp.Publisher", through="contract.Contract"),
                ),
            ],
        )
        contract = ModelState(
    ...
    def test_add_model_order_with_respect_to_constraint(self):
        ...
        self.assertOperationAttributes(
            ...
            options={
                "order_with_respect_to": "book",
                "constraints": [
                    models.CheckConstraint(condition=models.Q(_order__gt=1), name="book_order_gt_1")
                ],
            },
        )
        ...
        class Migration(migrations.Migration):
            operations = [
                migrations.AddConstraint(
                    "Person",
                    models.UniqueConstraint(fields=["name"], name="person.name-*~unique!"),
                ),
            ]
