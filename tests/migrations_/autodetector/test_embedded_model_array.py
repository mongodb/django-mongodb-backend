...
class EmbeddedModelArrayFieldAutodetectorTests(BaseAutodetectorTests):
    ...
    def test_rename_embedded_field(self):
        """Detection of renamed embedded fields."""
        changes = self.get_changes(
            [
                ModelState(
                    "testapp",
    ...
    def test_alter_field_to_not_null_with_default(self, mocked_ask_method):
        """
        Nullable to non-nullable alteration with a default doesn't
        prompt.
        """
        before = [
            ModelState(
    ...
    def test_alter_field_to_not_null_without_default(self, mocked_ask_method):
        """
        Nullable to non-nullable alteration without a default prompts
        once.
        """
        before = [
            ModelState(
    ...
    def test_rename_field(self):
        """
        Renaming a field generates only RenameField and
        RenameEmbeddedField.
        """
        changes = self.get_changes(
            [
    ...
    def test_add_field_with_default(self):
        """
        Adding a field with a default generates AddField and
        AddEmbeddedField.
        """
        before = [
            ModelState(
