...
class DatabaseFeatures(GISFeatures, BaseDatabaseFeatures):
    ...
    _django_test_expected_failures = {
        ...
        # The expected value was edited on the Django fork. If this patch is
        # accepted, these edits must be reverted when this patch is merged:
        "filtered_relation.tests.FilteredRelationAnalyticalAggregationTests.test_aggregate",
